...
% Bias instruction
\medskip
% Why we add bias instruction + cite

The prompt to update the opinion also includes a confirmation bias, because it was shown in this work <cite> that it creates more realistic agent behavior. % check paper
...
Misinformation agents are instead modeled with a stronger confirmation bias, as they are modeled to strongly support their views. The instruction, taken from <cite>, is here reported:
\begin{tcolorbox}[prompt]
